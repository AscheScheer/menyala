...
<body class="bg-gray-100 py-10">
    <div class="max-w-xl mx-auto bg-white p-5 rounded shadow">
        <h2 class="text-2xl font-bold mb-5">Edit student</h2>
        ...
        <form action="{{ route('students.update', $student->id) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="email" class="block text-gray-700 font-bold mb-2">No telepon</label>
            ...
            <a href="{{ route('student') }}" class="ml-3 text-gray-700 hover:underline">Batal</a>
        </form>
    </div>
</body>
</html>
